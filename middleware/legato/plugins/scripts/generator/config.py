def generateConfigFile():
	...
	configFile.write("#define LE_EXTERNAL_STREAMING_ENABLED      %d" % int(StateManager.getBoolean("ENABLE_EXTERNAL_MEDIA")))
	configFile.writeNewLine()
	...
	configFile.write("#define LE_BAR_GRAPH_WIDGET_ENABLED        %d" % int(StateManager.getBoolean("ENABLE_BARGRAPH_WIDGET")))
	...
	configFile.write("#define LE_CIRCULAR_GAUGE_WIDGET_ENABLED   %d" % int(StateManager.getBoolean("ENABLE_CIRCULARGAUGE_WIDGET")))
	configFile.write("#define LE_CIRCULAR_SLIDER_WIDGET_ENABLED  %d" % int(StateManager.getBoolean("ENABLE_CIRCULARSLIDER_WIDGET")))
	...
	configFile.write("#define LE_IMAGEPLUS_WIDGET_ENABLED        %d" % int(StateManager.getBoolean("ENABLE_IMAGEPLUS_WIDGET")))
	...
	configFile.write("#define LE_LINE_GRAPH_WIDGET_ENABLED       %d" % int(StateManager.getBoolean("ENABLE_LINEGRAPH_WIDGET")))
	...
	configFile.write("#define LE_PIE_CHART_WIDGET_ENABLED        %d" % int(StateManager.getBoolean("ENABLE_PIECHART_WIDGET")))
	configFile.write("#define LE_PROGRESSBAR_WIDGET_ENABLED      %d" % int(StateManager.getBoolean("ENABLE_PROGRESSBAR_WIDGET")))
	configFile.write("#define LE_RADIAL_MENU_WIDGET_ENABLED      %d" % int(StateManager.getBoolean("ENABLE_RADIALMENU_WIDGET")))
	...
	configFile.write("#define LE_ALPHA_BLENDING_ENABLED          %d" % int(StateManager.getBoolean("ENABLE_WIDGET_ALPHA_BLENDING")))
