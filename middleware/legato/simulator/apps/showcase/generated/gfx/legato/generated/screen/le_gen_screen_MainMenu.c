...
leResult screenShow_MainMenu()
{
    ...
    TouchTestDemoMenuDemo->fn->setPressedImage(TouchTestDemoMenuDemo, &GFX_Touch_80_drop);
    TouchTestDemoMenuDemo->fn->setReleasedImage(TouchTestDemoMenuDemo, &GFX_Touch_80_drop);
    ...
    LabelWidget1->fn->setPosition(LabelWidget1, 155, 182);
    ...
    LabelWidget2->fn->setPosition(LabelWidget2, 143, 214);
    LabelWidget2->fn->setSize(LabelWidget2, 190, 31);
