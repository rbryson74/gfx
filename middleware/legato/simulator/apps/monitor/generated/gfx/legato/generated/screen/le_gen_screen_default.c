...
leResult screenShow_default()
{
    ...
    SysValue1->fn->setHAlignment(SysValue1, LE_HALIGN_CENTER);
    ...
    SysValue10->fn->setHAlignment(SysValue10, LE_HALIGN_CENTER);
    ...
    SysValue100->fn->setHAlignment(SysValue100, LE_HALIGN_CENTER);
    ...
    DiaValue1->fn->setHAlignment(DiaValue1, LE_HALIGN_CENTER);
    ...
    DiaValue10->fn->setHAlignment(DiaValue10, LE_HALIGN_CENTER);
    ...
    DiaValue100->fn->setHAlignment(DiaValue100, LE_HALIGN_CENTER);
    ...
    PulseValue1->fn->setHAlignment(PulseValue1, LE_HALIGN_CENTER);
    ...
    PulseValue10->fn->setHAlignment(PulseValue10, LE_HALIGN_CENTER);
    ...
    PulseValue100->fn->setHAlignment(PulseValue100, LE_HALIGN_CENTER);
