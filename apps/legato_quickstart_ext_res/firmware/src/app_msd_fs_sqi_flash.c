...
#include "config/ssd1963_rgb565_mxt_msd_fs_sqi_flash/gfx/legato/widget/label/legato_widget_label.h"
#include "config/ssd1963_rgb565_mxt_msd_fs_sqi_flash/gfx/legato/widget/button/legato_widget_button.h"
...
//        LabelWidget2->fn->setString(LabelWidget2, (leString*)&tableString_ImageIsRaw);
//
...
//
//        //Draw the intended from the previous message
//        LogoButton->fn->setPressedImage(LogoButton, &MHGS_logo_small_raw_rle);
//        LogoButton->fn->setReleasedImage(LogoButton, &MHGS_logo_small_raw_rle);
...
//    {
//        //Show the next message
//        LabelWidget2->fn->setString(LabelWidget2, (leString*)&tableString_DrawRaw);
//
//        //Draw the intended from the previous message
